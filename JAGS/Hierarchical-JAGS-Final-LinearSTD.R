...
#
# 1) Standardizes covariates within time-series for each pop, the were previously standardized at pop. level but across entire timeseries.
#
#
#==================================================================================================
#NOTES:
...
dir.output <- file.path(dir.output,"Final_New_LinearSTD",paste0("Phase_",phase))
dir.create(dir.output, recursive=TRUE)
dir.figs <- file.path(dir.figs,"Final_New_LinearSTD",paste0("Phase_",phase))
