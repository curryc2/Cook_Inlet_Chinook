...
# names.covars.3 <- c('wksGT13_spawn','wksGT15_rear', 
#                     'maxP_spawn','avgP_rear',
#                     'medianQ_rear','RB_spawn','RB_emerge',
#                     'breakup','NPGO')

names.covars.4 <- c('maxT_spawn','avgT_rear', 
                    'maxP_spawn','avgP_rear',
                    'medianQ_rear','RB_spawn','RB_emerge',
                    'breakup','NPGO')
...
mu.list <- cbind(out.4$BUGSoutput$sims.list$mu.coef)
                 ...
                 # out.4$BUGSoutput$sims.list$mu.coef[,1:2], # maxT_spawn, avgT_rear
...
caterplot(mu.list,
          labels=names.covars.4, reorder=FALSE, quantiles=list(0.025,0.25,0.75,0.975),
...
# 
# # Phase 4 model: maxT_spawn and avgT_rear
...
# #                                    levels=c('wksGT13_spawn','wksGT15_rear', 
# #                                             'maxT_spawn','avgT_rear',
# #                                             'maxP_spawn','avgP_rear',
# #                                             'RB_spawn','RB_emerge',
# #                                             'medianQ_rear',
# #                                             'breakup','NPGO'))
