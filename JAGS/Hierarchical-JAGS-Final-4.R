...
dir.figs <- file.path(dir.figs,"Final_New_correct",paste0("Phase_",phase))
...
temp.dat.3 <- temp.dat.2
temp.dat.3$std.wksGT13 <- (temp.dat.3$wksGT13 - mean(temp.dat.3$wksGT13 , na.rm=TRUE))/sd(temp.dat.3$wksGT13, na.rm=TRUE)
